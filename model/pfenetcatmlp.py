...
class Model(nn.Module):
    ...
    def forward(self, x, s_x=torch.FloatTensor(1,1,3,473,473).cuda(), s_y=torch.FloatTensor(1,1,473,473).cuda(), s_seed=None, y=None):
        ...
        for i, tmp_supp_feat in enumerate(final_supp_list):
            ...
            s = self.mlp(F.avg_pool2d(input=tmp_supp_feat,kernel_size=tmp_supp_feat.shape[-2:]).squeeze(3).squeeze(2)) # bsize x c x 1 x 1
            ...
            tmp_supp = s.unsqueeze(2) # bsize, ch_sz, 1
