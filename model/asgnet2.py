...
########################### Context Module ###########################
        if self.pyramid:
            ...
            for idx, tmp_bin in enumerate(self.pyramid_bins):
                ...
                corr_query_mask = F.interpolate(corr_query_mask, size=(bin, bin), mode='bilinear', align_corners=True)
                merge_feat_bin = torch.cat([guide_feat_bin, corr_query_mask], 1)
